...
export const YearPicker = ({ route }) => {
  ...
  const [YearSelected, setYearSelected] = React.useState('2022');
          ...
          return (
            ...
            >
              <Text style={[styles.monthFontStyles]}>
                {yearData.name}
                <Text style={{ fontSize: FontSize.x4large,color:AppColors.white }}>s</Text>
              </Text>
              <VertSpace size={40} />
              {/* YEAR LIST */}
              <ScrollView
                ...
                {tempArray.map((_, index) => {
                  ...
                  return (
                    <Fragment key={index.toString()}>
                      <TouchableRipple
                       onPress={() => {
                  route.params.onReturn(yearString), navigation.goBack();
                }}
                      
                        // onPress={() => {
                        //   navigation.navigate({route.params.onReturn(yearString), navigation.goBack()
